                ...
                <div class="card-body">
                    <form id="formCreate" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-4">
                             ...
                             <div  class="col-md-6">
                                <input type="text" class="form-control @error('p_iva') is-invalid @enderror" name="p_iva">
                                @error('p_iva')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                             </div>
                        ...
                        <div class="mb-4 d-flex w-50 ">
                            <div>
                                 @foreach($types as $type)
                                  <div>
                                     <label>
                                         <input class="@error($type->name) is-invalid @enderror category-checkbox" type="checkbox" name="category_id[]" value="{{ $type->id }}"> {{ $type->name }}
                                     </label>
                                 </div>
                                 @endforeach
                                    @error('category_id')
